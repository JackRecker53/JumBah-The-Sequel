...
const UnlockableContent = ({ userProfile, onContentUnlock }) => {
      ...
      articles: [
        {
          ...
          description:
            "Discover secret spots that only locals know about in Sabah's capital city.",
          author: "Sarah Chen",
          readTime: "5 min read",
          ...
          requiredPoints: 150,
          image:
            "https://sabahtravel-assets.s3.amazonaws.com/images/20200205-ui34r-kota-kinabalu-signal-hill--1--copy-jpg",
        ...
        },
        {
          ...
          description:
            "Everything you need to know before attempting Malaysia's highest peak.",
          ...
          requiredPoints: 500,
          image:
            "https://www.borneoecotours.com/images/cache/tours/gallery/kundasang/mount-kinabalu/climb-mt-kinabalu-04-1800x1200.webp",
      ...
      videos: [
        {
          ...
          description:
            "A stunning 20-minute documentary showcasing Sabah's incredible biodiversity.",
          duration: "20:15",
          category: "Nature",
          unlockRequirement: "Complete 5 nature quests",
          requiredPoints: 250,
          thumbnail:
            "https://borneoadventure.com/v3/wp-content/uploads/2022/05/sabah-labuk-probo-11.jpg",
        ...
        },
        {
          ...
          description:
            "Learn about the rich cultural heritage through traditional performances.",
          duration: "15:30",
          category: "Culture",
          unlockRequirement: "Complete all cultural quests",
          requiredPoints: 400,
          thumbnail:
            "https://www.mysabah.com/wordpress/wp-content/uploads/2021/06/20210704_2.jpg",
      ...
      recipes: [
        {
          ...
          description:
            "Traditional Kadazan-Dusun raw fish salad with lime and chili.",
          difficulty: "Medium",
          cookTime: "30 minutes",
          ...
          requiredPoints: 180,
          image:
            "https://www.iloveborneo.my/wp-content/uploads/2022/11/192641977_311851713865257_4546435731127599506_n.jpg.webp",
          ingredients: [
            "Fresh fish",
            "Lime juice",
            "Chili",
        ...
        },
        {
          ...
          description:
            "Sweet and sour pickle made from wild mango, a Sabahan delicacy.",
          difficulty: "Easy",
          cookTime: "45 minutes",
          category: "Snacks",
          ...
          requiredPoints: 120,
          image:
            "https://preview.redd.it/szzkhp3u7gs61.jpg?width=640&crop=smart&auto=webp&s=10b3d9ae658ae1adee404144319f960d80c46fe7",
      ...
      souvenirs: [
        {
          ...
          description:
            "A beautiful digital badge featuring the Sabah state flag.",
          category: "Badge",
          unlockRequirement: "Complete first quest",
          requiredPoints: 50,
          image:
            "https://ecentral.my/wp-content/uploads/2024/06/bendera-sabah-768x402.png",
          rarity: "Common",
        ...
        },
        {
          ...
          description:
            "Virtual certificate commemorating your Mount Kinabalu adventure.",
          category: "Certificate",
          unlockRequirement: "Complete Mount Kinabalu quest",
          requiredPoints: 500,
          image:
            "https://www.tamannegara.asia/wp-content/uploads/2017/03/GunungKinabalu9-600x371.jpg",
          rarity: "Legendary",
          unlocked: (userProfile?.total_points || 0) >= 500,
        },
        {
          ...
          requiredPoints: 300,
          image:
            "https://static.vecteezy.com/system/resources/previews/047/927/789/non_2x/orang-utan-cartoon-illustration-isolated-on-white-background-vector.jpg",
          rarity: "Rare",
  ...
  const tabIcons = [
    <Article key="article" />,
    <PlayCircle key="video" />,
    <Restaurant key="recipe" />,
    <CardGiftcard key="souvenir" />,
  ];
  ...
  const handleUnlockContent = async (content) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:8000/api/users/profile/${userProfile.user_id}/unlock-content`,
        {
          method: "POST",
          headers: {
  ...
  const ContentCard = ({ content, type }) => {
    ...
    const canUnlock =
      (userProfile?.total_points || 0) >= content.requiredPoints;
              ...
              {getCurrentTabData().map((content) => (
                <Grid item xs={12} sm={6} md={4} key={content.id}>
                  <ContentCard
                    content={content}
                    type={
                      ["articles", "videos", "recipes", "souvenirs"][
                        selectedTab
                      ]
                    }
                  />
          ...
          <>
            ...
            <DialogContent sx={{ p: 0 }}>
              ...
              <Box sx={{ p: 3 }}>
                ...
                {selectedContent.type === "recipes" &&
                  selectedContent.ingredients && (
                    <Box sx={{ mt: 3 }}>
                      <Typography variant="h6" gutterBottom>
                        Ingredients
                      </Typography>
                      <List dense>
                        {selectedContent.ingredients.map(
                          (ingredient, index) => (
                            <ListItem key={index}>
                              <ListItemIcon>
                                <Star sx={{ fontSize: 16 }} />
                ...
                {selectedContent.unlocked ? (
                  <Box sx={{ mt: 3, textAlign: "center" }}>
                    <Button
                      ...
                      sx={{
                        background:
                          "linear-gradient(45deg, #072b80 30%, #0484d6 90%)",
                        mr: 2,
                      }}
                    >
                  ...
                  >
                    ...
                    <LinearProgress
                      ...
                      value={Math.min(
                        ((userProfile?.total_points || 0) /
                          selectedContent.requiredPoints) *
                          100,
                        100
                      )}
                      sx={{
                    ...
                    >
                      {userProfile?.total_points || 0} /{" "}
                      {selectedContent.requiredPoints} points
                    </Typography>
                  </Box>
                )}
              </Box>
